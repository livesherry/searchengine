...
//video suggestion slider
         
 $(document).ready(function(){
    $(".g-scrolling-carousel-rel .itemsrel").gScrollingCarouselrel();
  });
  
  (function($) {
    $.fn.extend({
        gScrollingCarouselrel: function(options) {
            ...
            if (!supportsTouch){
                ...
                leftElem = $('<span />').addClass('jc-leftrel').html('<svg focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z"></path></svg>');
                rightElem = $('<span />').addClass('jc-rightrel').html('<svg focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"></path></svg>');
                ...
                element.bind("mousedown", function(e){
                    ...
                    if(down){
                        ...
                        element.removeClass("nonclickrel");
                    }
                });
                rightElem.bind("click", function(e){
                  leftElem.fadeIn(200);
                  items = $(this).siblings(".itemsrel");
